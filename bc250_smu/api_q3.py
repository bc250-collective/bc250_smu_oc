...
class Queue3Mixin:
    ...
    def get_core_clock(self, core_id: int) -> int:
    ...
    def q3_0x49_set_cpu_vid_offset(self, volts: float = 0.0) -> int | None:
    ...
    def q3_0x50_scale_f_vid_curve(self, scaling: int = 0) -> int | None:
